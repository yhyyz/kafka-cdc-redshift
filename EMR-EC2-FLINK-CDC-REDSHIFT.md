...
export APP_LOCAL_HOME="/home/hadoop/$APP_NAME"

export CDC_UTIL_WHL_NAME="cdc_util_202406190314-1.1-py3-none-any.whl"
...
export JOB_CONFIG_PATH="$APP_S3_HOME/script/job-ec2-tpcc.properties"
...
aws s3 cp ./script/job-ec2-tpcc.properties $APP_S3_HOME/script/
```
